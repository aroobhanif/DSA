...
$getfield = '?q=riodejaneiro&count=30'; // We're searching for #riodejaneiro and return 30 (max) tweets each time
$requestMethod = 'GET';
...
foreach ($tweets->statuses as $tweet) {
     $query = $mysqli->prepare("INSERT INTO riotweets (id_str, screen_name, tweet) VALUES (?, ?, ?)");
